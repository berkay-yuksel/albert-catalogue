...
export const metadata: Metadata = {
  title: "About — Albert Family",
  description: "About Albert Family, a B2B wholesale supplier of gold chains, fine jewelry, and tobacco pipes.",
};
  ...
  return (
    <>
      ...
      <main className="static-page">
        ...
        <h1>About Albert Family</h1>
        <p className="static-lede">
          Albert Family is a B2B wholesale supplier of gold chains, fine jewelry, and tobacco
